    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.windowsControls, [
                ...
                SettingsDirectoryItem(page: .switcher, title: s.tabSwitcher, icon: "rectangle.on.rectangle",
                                      keywords: [s.switcherEnable, s.dockClickMinimize, s.dockClickHide,
                                                 ...
                                                 FeatureStrings.quickLaunch(language).sectionTitle,
                                                 FeatureStrings.quickLaunch(language).enableToggle,
                                                 FeatureStrings.quickLaunch(language).prioritiesTitle]),
            ...
            (categories.utilities, [
                SettingsDirectoryItem(page: .pixelRuler,
                                      title: FeatureStrings.pixelRuler(language).pageTitle,
                                      icon: "ruler",
                                      keywords: ["measure", "distance", "edge detection", "tolerance",
                                                 "pixelsnap"]),
