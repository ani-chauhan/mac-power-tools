...
/// The interface language. English-only; kept as a type (rather than removed
/// outright) because many per-feature `Strings` catalogs still key off it.
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Mac Power Tools: normal sleep",
        statusActiveUntil: "Mac Power Tools: awake until",
        statusActiveIndefinite: "Mac Power Tools: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Mac Power Tools",
        menuQuit: "Quit Mac Power Tools",
        menuHide: "Hide Mac Power Tools",
        ...
        keepAwakeActiveIconVorssaint: "Mac Power Tools",
        ...
        notifyBatteryTitle: "Mac Power Tools disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "Mac Power Tools needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "Mac Power Tools needs your password to restore the Mac's normal sleep.",
        adminPromptRecover: "Mac Power Tools quit while the Mac's sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "Mac Power Tools needs your password to install the update.",
        adminPromptSudoersInstall: "Mac Power Tools will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Mac Power Tools will remove the password-free closed-lid rule.",

        settingsTitle: "Mac Power Tools Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted Mac Power Tools (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Mac Power Tools to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Mac Power Tools completely",
        advancedUninstallConfirmTitle: "Uninstall Mac Power Tools?",
        advancedUninstallConfirmBody: "Mac Power Tools will clear its permissions, remove its preferences and move to the Trash, then quit. This can't be undone from the app, but it stays in the Trash until you empty it.",
        ...
        keepAwakeAutoStart: "Keep Awake when Mac Power Tools opens",
        ...
        switcherEnable: "Use the Mac Power Tools switcher",
        ...
        uninstallerFDAHint: "Turn Mac Power Tools on in the list. If it isn't there, click + and pick Mac Power Tools from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "Mac Power Tools can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. Mac Power Tools can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. Mac Power Tools does not capture passwords.",
        ...
        updateNotifyTitle: "Mac Power Tools update",
        ...
        updateNeedsApplicationsTitle: "Move Mac Power Tools to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag Mac Power Tools to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open Mac Power Tools",
        obStepWelcomeTitle: "Welcome to Mac Power Tools",
        ...
        obStepDoneBody: "Mac Power Tools is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Mac Power Tools now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Mac Power Tools needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help Mac Power Tools keep growing",
        donateMessage: "Mac Power Tools is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help Mac Power Tools keep growing",
        supportIntroMessage: "A star on GitHub helps more people discover Mac Power Tools and makes a real difference to its development.",
        supportIntroStarButton: "Star Mac Power Tools on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover Mac Power Tools and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The Mac Power Tools Discord community is just getting started",
        discordIntroMessage: "The Mac Power Tools community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        homebrewOfficialIntroMessage: "Mac Power Tools can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If Mac Power Tools's icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Mac Power Tools from Applications or Spotlight: that rebuilds the icon and, if it's still hidden, opens this window. The button above does the same when you can already get here. Keeping fewer menu bar icons, or fewer Mac Power Tools metrics, makes it far less likely.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for Mac Power Tools there, or set %@ to always show Mac Power Tools.",
        ...
        cleanerNotifDenied: "Mac Power Tools notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag Mac Power Tools to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn Mac Power Tools on under Open at Login.",
