...
extension RecorderShareStrings {
    static let enUS = RecorderShareStrings(
        ...
        privacyData: "Mac Power Tools sends only the final video created from this recording, including the audio you kept, and the expiration you choose. It does not send your name, account or device identifier.",
