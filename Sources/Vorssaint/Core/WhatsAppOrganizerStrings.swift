...
extension WhatsAppOrganizerStrings {
    static let enUS = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp may download a moved file again. Mac Power Tools cannot prevent the network download, but it can detect and discard an identical extra copy.",
