...
extension ScreenshotFeatureStrings {
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Captura longa: a qualidade pode cair para continuar",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Uzun yakalama: devam etmek için kalite düşebilir",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Долгая съёмка: качество может снизиться, чтобы продолжить",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Captura larga: la calidad puede bajar para continuar",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Lange Aufnahme – die Qualität kann sinken, um fortzufahren",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Capture longue : la qualité peut baisser pour continuer",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Cattura lunga: la qualità potrebbe calare per continuare",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "長時間の撮影です。続行のため画質が下がる場合があります",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "긴 캡처입니다. 계속하기 위해 화질이 낮아질 수 있습니다",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "截图很长，为继续可能会降低画质",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "截圖很長，為了繼續可能會降低畫質",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "截圖好長，為咗繼續可能會降低畫質",
        editLastCapture: "編輯最新截圖",
        lastCaptureMissing: "請先擷取一張截圖",
        fullScreenShortcutTitle: "擷取整個螢幕",
        bringForward: "上移一層",
