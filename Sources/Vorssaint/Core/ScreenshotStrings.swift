...
struct ScreenshotFeatureStrings {
    ...
    let scrollingCaptureLongWarningHUD: String
...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        scrollingCaptureLongWarningHUD: "Long capture: quality may drop to keep going",
        ...
        sharePrivacyData: "Mac Power Tools sends only the rendered image and the expiration you choose. It does not send your name, account, device identifier or MAC address. On this Mac, it keeps only the link, expiration and private deletion token while the link is active.",
        ...
        hideVorssaintWindowsToggle: "Hide Mac Power Tools windows",
