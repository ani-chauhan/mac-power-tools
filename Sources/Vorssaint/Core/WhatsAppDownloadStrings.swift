...
extension WhatsAppDownloadStrings {
    static let enUS = WhatsAppDownloadStrings(
        ...
        accessDenied: "Mac Power Tools cannot access Downloads. Allow it in Files & Folders.",
        ...
        localNote: "Only local file metadata is inspected. Mac Power Tools never reads chats or file contents.",
